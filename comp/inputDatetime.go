...
func (d inputDatetime) set(key string, value interface{}) inputDatetime {
	d[key] = value
	return d
}
...
// OnEvent 事件动作配置
func (d inputDatetime) OnEvent(value string) inputDatetime {
...
// Style 组件样式
func (d inputDatetime) Style(value string) inputDatetime {
