...
type (
	ChartCfg  schema.Schema
	ChartSeri schema.Schema
	ChartAxis schema.Schema
)
...
func (c ChartSeri) LineStyle(value schema.Schema) ChartSeri {
	return c.Set("lineStyle", value)
}

func (c ChartSeri) AreaStyle(value schema.Schema) ChartSeri {
